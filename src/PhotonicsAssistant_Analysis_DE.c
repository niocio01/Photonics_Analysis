...
frage_t fragen_Differential_1[6]= {0,0,0};

fragen_Differential_1[0].frage = "Das stimmt genau so.";
...
frage_t *p_fragen_Differential_1 = &fragen_Differential_1[0]		// Pointer auf die erste Arraystelle pro Thema
...
frage_t *p_fragen pionterUebergabe(themen_t thema)		//Funktion um Pointer zurückzugeben
{
	switch(thema) {
